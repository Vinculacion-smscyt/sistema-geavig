...
# Diccionario de mapeo de SMZ/Región a Sector
SECTORES_MAP = {
    "1": "SECTOR 1", "2": "SECTOR 1", "2A": "SECTOR 1", "3": "SECTOR 1", "4": "SECTOR 1", "5": "SECTOR 1",
    "15": "SECTOR 1", "15A": "SECTOR 1", "15B": "SECTOR 1", "16": "SECTOR 1", "17": "SECTOR 1", "18": "SECTOR 1",
    "19": "SECTOR 1", "20": "SECTOR 1", "21": "SECTOR 1", "22": "SECTOR 1", "23": "SECTOR 1", "24": "SECTOR 1",
    "25": "SECTOR 1", "26": "SECTOR 1", "27": "SECTOR 1", "28": "SECTOR 1", "29": "SECTOR 1", "30": "SECTOR 1",
    "31": "SECTOR 1", "32": "SECTOR 1", "33": "SECTOR 1", "34": "SECTOR 1", "35": "SECTOR 1", "36": "SECTOR 1",
...
with st.form("form_geavig"):
    ...
    with col4:
        ...
        try:
            ...
            horas_calc = total_min // 60
            min_calc = total_min % 60
            if horas_calc > 0:
                tiempo_atencion_str = f"{horas_calc} HRS {min_calc} MIN"
            else:
                tiempo_atencion_str = f"{min_calc} MIN"
        except:
    ...
    if submitted:
        ...
        if not latitud.strip():
            errores.append("La Latitud es obligatoria para continuar.")
        if not longitud.strip():
            errores.append("La Longitud es obligatoria para continuar.")
